    ...
    <div>
      ...
      >
        ...
        <div class="flex item">
          ...
          <div style="padding: 0 10px; flex: 1" @click="deleteChild(record)">
            删除
          </div>
        </div>
      </div>
...
<script>
import { getChildrenList, getUserInfo, deleteChildren } from '@/api/home';
                        ...
                        : this.userInfo.Type === 12
                          ...
                          : this.userInfo.Type === 14
                            ...
                            : this.userInfo.Type === 15
                              ? '校儿童督导员'
                              : '村级讲师';
          getChildrenList(this.Token)
            .then((res) => {
              console.log('getVisitList', res);
              this.myRecordsList = res.data.childrenList;
    ...
    deleteChild(child) {
      this.$dialog
        ...
        .then(() => {
          // on confirm
          console.log('queding');
          deleteChildren(this.Token, child.Id)
            .then((res) => {
